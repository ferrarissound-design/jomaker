import { makeAnimeEnemy, animateAnimeEnemy } from './anime-enemies.js?v=20260916-trike-direction-1';
import { TILE, PARTS } from './stage.js?v=20260916-trike-direction-1';
import { initAnimeStyle, makeGrassBlock, buildAnimeBackdrop } from './anime-world.js?v=20260916-trike-direction-1';
...
export class ThreePlayRenderer {
  constructor(THREE, canvas, stage) {
    ...
    this.playerLeftJumpTexture = playerTextureLoader.load('./70FE4599-3EA7-4DB1-A5DA-43DE8A833E60.png', texture => {
      texture.colorSpace = THREE.SRGBColorSpace;
    });
  ...
  updateDynamic(game, time) {
    ...
    const jumpingLeft = !game.player.grounded && playerFacing < 0;
