...
import { ThreePlayRenderer } from '../src/render3d.js?v=20260916-trike-default-left-1';
...
test('2D player chooses dedicated left artwork without mirroring and keeps fallback',async()=>{
  ...
  try {
    const {drawPlayer}=await import('../src/render.js?v=20260916-trike-default-left-1');
